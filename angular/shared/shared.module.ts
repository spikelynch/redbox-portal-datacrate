...
import { DataCrateService } from './form/field-datalocation.component';
...
@NgModule({
  ...
  providers:    [ FieldControlService, RecordsService, VocabFieldLookupService, ConfigService, TranslationService, UserSimpleService, DashboardService, RolesService, EmailNotificationService, UtilityService, WorkspaceTypeService, DataCrateService ],
  bootstrap:    [ ],
